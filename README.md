...
retains declared artifact sizes when present, and represents package index URLs
only by SHA-256 fingerprints. It counts lock fields it does not project and
does not create a `rh-dep-graph/1` or OSV input.
