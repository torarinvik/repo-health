...
archives; Go module hashes, SHA-384-only npm integrity, integrity strings
without SHA-256/SHA-512, SRI options, and graph rewrites remain unsupported.
