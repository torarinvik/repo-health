...
|---|---|---|
| M00 contracts/oracles | `implemented` | `src/rh_*.elisa`, `build/test_oracles` (`ORACLES OK`), `tests/test_m00.sh`, 211 explicitly classified metric definitions, CHAOSS Contributor Absence Factor crosswalk and negative admission controls (`tests/test_metric_admission.sh`) |
