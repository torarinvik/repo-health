...
remain unsupported, and no archive is opened or extracted. Complete artifact
metadata, environment/group selection, and unsupported source forms remain
coverage gaps. `tests/test_pylock_cli.sh`, its audit and observation goldens, schema
