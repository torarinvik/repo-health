...
bounded path does not extract or execute archives; Go module ZIP hashes, integrity
...
`rh-go-mod-observation-result/1`; module ZIP `dirhash` verification remains
open. Registry metadata now also has a bounded `https`/`file`
...
86 public machine-readable contracts, including the research lineage,
