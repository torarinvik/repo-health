...
environment/group selection, complete artifact metadata, unsupported dependency
selector fields, and complete TOML grammar remain coverage gaps. `tests/test_pylock_cli.sh`, its audit and
