...
| adoption.snapshot_coverage_gap_count | 1.0.0 | `implemented` (M05-07; uncovered intervals in caller-supplied complete comparable snapshot coverage) |
| adoption.snapshot_coverage_uncovered_seconds | 1.0.0 | `implemented` (M05-07; elapsed seconds not covered by caller-supplied comparable snapshot intervals) |
