...
| [P19] | Validate `h1` checksums as canonical Base64 SHA-256 while keeping Go module ZIP hash verification explicitly open. |
| [P20] | Bind Go `go.mod` file verification to the one-file `h1` summary; keep ZIP module hashing open until bounded ZIP/DEFLATE handling is available. |
