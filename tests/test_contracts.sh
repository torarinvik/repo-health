...
for want in ("dep-graph", "canonical-repo", "bundle-manifest", "report",
             ...
             "roles-result", "roles-fetch", "experimental-result", "report-html", "explain-markdown", "benchmark-manifest", "profile-manifest", "proof-result", "forecast-input", "forecast-result", "intervention-result", "mapping-result", "coverage-result", "columnar-snapshot", "aggregate-result", "index-manifest", "adoption-result", "lineage-result", "population-result", "ingest-conformance-result", "evidence-drilldown", "evidence-transfer", "role-grain-result", "arch-pkgbuild-result",
             "notify-state", "store-lease-result", "policy-state",
             "corrections-state", "connector-instance", "job-next",
             "job-schedule-result",
             "reconcile-result", "snapshot-reconcile-input", "snapshot-reconcile-result", "job-schedule-result", "projection-snapshot", "github-capability-probe-result", "github-capability-matrix", "github-traffic-observation",
             "worker-plan", "succession-metric", "adapter-manifest-result", "research-conformance", "pilot-review-result", "provider-roles-input", "ecosystem-lookup-result", "forge-events-input", "forge-events-result", "ingest-input", "postgres-legacy-ingest-input", "postgres-staged-github-issues-input", "postgres-staged-github-proposals-input", "postgres-staged-github-reviews-input", "postgres-staged-github-releases-input", "postgres-staged-gitlab-issues-input", "postgres-staged-normalize-result", "postgres-command", "postgres-result", "osv-query-input", "osv-commit-query-input", "osv-query-result", "osv-query-pages-result", "osv-query-batch-result", "osv-query-batch-pages-result", "osv-query-batch-hydrated-result", "pylock-audit", "pylock-artifact-observation-result"):
