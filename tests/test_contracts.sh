...
for want in ("dep-graph", "canonical-repo", "bundle-manifest", "report",
             ...
             "roles-result", "roles-fetch", "experimental-result", "report-html", "explain-markdown", "profile-manifest", "proof-result", "forecast-result", "intervention-result", "mapping-result", "coverage-result", "columnar-snapshot", "aggregate-result", "index-manifest",
