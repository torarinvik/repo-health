...
for want in ("dep-graph", "canonical-repo", "bundle-manifest", "report",
             ...
             "identity-publication-result", "role-publication-result", "distribution-result", "archive-result", "homebrew-result",
             ...
             "roles-result", "roles-fetch", "experimental-result", "report-html", "explain-markdown", "profile-manifest", "proof-result", "forecast-result", "intervention-result", "mapping-result", "coverage-result", "columnar-snapshot", "aggregate-result", "index-manifest", "adoption-result", "lineage-result", "population-result", "ingest-conformance-result", "evidence-drilldown", "role-grain-result",
             ...
             "worker-plan", "succession-metric", "adapter-manifest-result", "research-conformance", "pilot-review-result"):
