...
for want in ("dep-graph", "canonical-repo", "bundle-manifest", "report",
             ...
             "worker-plan", "succession-metric", "adapter-manifest-result", "research-conformance", "pilot-review-result", "provider-roles-input", "ecosystem-lookup-result", "forge-events-input", "forge-events-result", "ingest-input", "osv-query-input", "osv-commit-query-input", "osv-query-result", "osv-query-pages-result", "osv-query-batch-result", "osv-query-batch-pages-result", "osv-query-batch-hydrated-result", "pylock-audit"):
