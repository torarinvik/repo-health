...
{"schema":"rh-pylock-audit/1","environments":["sys_platform == 'linux' or sys_platform == 'win32'"],"packages":[{"name":"yes","version":"1.0","marker":"python_version >= '3.10'"},{"name":"no","version":"2.0","marker":"sys_platform == 'win32'"},{"name":"unknown","version":null,"marker":"platform_release == 'future'"}]}
JSON
cat >"$TMP/context.json" <<'JSON'
{"schema":"rh-pylock-evaluation-context/1","environment":{"python_version":"3.12","sys_platform":"linux"},"dependency_groups":["dev"],"extras":[]}
JSON
