...
mkdir -p "$T/docs" && git init -q -b main "$T/docs" && (
  ...
  git add README.md CONTRIBUTING.md LICENSE INSTALL.md API.md GOVERNANCE.md .github/CODEOWNERS NOTICE RELEASE.md HANDOVER.md examples
