...
# and ack/resolve to an rh-notify-input/1 event stream, writing
# rh-notify-result/1. The non-negotiable rule: an upstream maintainer is
...
rm -rf "$T"; mkdir -p "$T"
cat > "$T/in.json" <<'JSON'
{"schema":"rh-notify-input/1","cooldown_secs":3600,"events":[
{"op":"notify","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa","target":"subscriber","now":1000},
{"op":"notify","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa","target":"upstream_maintainer","subscribed":false,"now":1000},
{"op":"notify","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa","target":"subscriber","now":2000},
{"op":"notify","rule_id":1,"subject_id":7,"artifact_digest":"bbbbbbbbbbbbbbbb","target":"subscriber","now":2000},
{"op":"notify","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa","target":"subscriber","now":9000},
{"op":"notify","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa","target":"subscriber","now":9500,"outage":true},
{"op":"ack","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa"},
{"op":"notify","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa","target":"subscriber","now":99999},
{"op":"resolve","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa"},
{"op":"notify","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa","target":"subscriber","now":999999}
]}
JSON
...
assert d["schema"] == "rh-notify-result/1", d
...
{"op":"notify","rule_id":2,"subject_id":9,"artifact_digest":"cccccccccccccccc","target":"subscriber","now":1001}
]}
JSON
...
cat > "$T/sub.json" <<'JSON'
{"schema":"rh-notify-input/1","cooldown_secs":0,"events":[
...
cat > "$T/ack.json" <<'JSON'
{"schema":"rh-notify-input/1","events":[{"op":"ack","rule_id":9,"subject_id":9,"artifact_digest":"9999999999999999"}]}
JSON
...
cat > "$T/pn.json" <<'JSON'
{"schema":"rh-notify-input/1","cooldown_secs":3600,"events":[{"op":"notify","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa","target":"subscriber","now":1000}]}
JSON
cat > "$T/pn2.json" <<'JSON'
{"schema":"rh-notify-input/1","cooldown_secs":3600,"events":[{"op":"notify","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa","target":"subscriber","now":2000}]}
JSON
printf '{"schema":"rh-notify-input/1","events":[{"op":"ack","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa"}]}' > "$T/pack.json"
printf '{"schema":"rh-notify-input/1","events":[{"op":"resolve","rule_id":1,"subject_id":7,"artifact_digest":"aaaaaaaaaaaaaaaa"}]}' > "$T/pres.json"
S="$T/state.json"
...
printf '{"schema":"rh-notify-input/2","events":[]}' > "$T/badschema.json"
"$ROOT/build/rh_cli" notify --input "$T/badschema.json" --out "$T/x" >/dev/null 2>&1; rc_schema=$?
printf '{"schema":"rh-notify-input/1","events":[{"op":"notify","rule_id":1,"subject_id":1,"artifact_digest":"1111111111111111","target":"stranger","now":1}]}' > "$T/badtarget.json"
"$ROOT/build/rh_cli" notify --input "$T/badtarget.json" --out "$T/x" >/dev/null 2>&1; rc_target=$?
printf '{"schema":"rh-notify-input/1","events":[{"op":"notify","rule_id":1,"subject_id":1,"artifact_digest":"zz","target":"subscriber","now":1}]}' > "$T/baddigest.json"
"$ROOT/build/rh_cli" notify --input "$T/baddigest.json" --out "$T/x" >/dev/null 2>&1; rc_digest=$?
printf '{"schema":"rh-notify-input/1","events":[{"op":"shout","rule_id":1,"subject_id":1,"artifact_digest":"1111111111111111"}]}' > "$T/badop.json"
...
for rc in "$rc_schema" "$rc_target" "$rc_digest" "$rc_op" "$rc_missing"; do
