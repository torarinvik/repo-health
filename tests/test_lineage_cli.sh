...
assert d["metric_class_counts"] == {"raw": 1, "derived": 1, "modeled": 1}, d
assert d["transformations"][3]["state"] == "discarded", d
assert d["metrics"][2]["class"] == "modeled", d
