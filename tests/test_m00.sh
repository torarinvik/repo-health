...
[[ "$keys_count" == "129" ]] || { echo "[m00] FAIL: expected 129 definitions, got $keys_count"; exit 1; }
...
assert impl == 127, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 127 implemented")
EOF
...
grep -q "233 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
