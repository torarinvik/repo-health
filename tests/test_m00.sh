...
[[ "$keys_count" == "161" ]] || { echo "[m00] FAIL: expected 161 definitions, got $keys_count"; exit 1; }
...
assert impl == 159, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 159 implemented")
EOF
...
grep -q "201 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
