...
[[ "$keys_count" == "188" ]] || { echo "[m00] FAIL: expected 188 definitions, got $keys_count"; exit 1; }
...
assert impl == 186, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 186 implemented")
EOF
...
grep -q "174 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
