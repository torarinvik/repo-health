...
[[ "$keys_count" == "133" ]] || { echo "[m00] FAIL: expected 133 definitions, got $keys_count"; exit 1; }
...
assert impl == 131, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 131 implemented")
EOF
...
grep -q "229 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
