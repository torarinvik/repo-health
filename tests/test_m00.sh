...
[[ "$keys_count" == "22" ]] || { echo "[m00] FAIL: expected 22 definitions, got $keys_count"; exit 1; }
...
assert impl == 20, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 20 implemented")
EOF
