...
[[ "$keys_count" == "187" ]] || { echo "[m00] FAIL: expected 187 definitions, got $keys_count"; exit 1; }
...
assert impl == 185, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 185 implemented")
EOF
...
grep -q "175 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
