...
[[ "$keys_count" == "97" ]] || { echo "[m00] FAIL: expected 97 definitions, got $keys_count"; exit 1; }
...
assert impl == 95, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 95 implemented")
EOF
...
grep -q "265 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
