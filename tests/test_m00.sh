...
[[ "$keys_count" == "135" ]] || { echo "[m00] FAIL: expected 135 definitions, got $keys_count"; exit 1; }
...
assert impl == 133, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 133 implemented")
EOF
...
grep -q "227 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
