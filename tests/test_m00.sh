...
[[ "$keys_count" == "204" ]] || { echo "[m00] FAIL: expected 204 definitions, got $keys_count"; exit 1; }
...
assert impl == 202, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 202 implemented")
EOF
...
grep -q "158 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
