...
[[ "$keys_count" == "226" ]] || { echo "[m00] FAIL: expected 226 definitions, got $keys_count"; exit 1; }
...
assert impl == 224, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 224 implemented")
EOF
