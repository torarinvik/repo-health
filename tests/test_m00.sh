...
[[ "$keys_count" == "77" ]] || { echo "[m00] FAIL: expected 77 definitions, got $keys_count"; exit 1; }
...
assert impl == 75, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 75 implemented")
EOF
...
grep -q "285 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
