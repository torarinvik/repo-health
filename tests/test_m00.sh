...
[[ "$keys_count" == "166" ]] || { echo "[m00] FAIL: expected 166 definitions, got $keys_count"; exit 1; }
...
assert impl == 164, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 164 implemented")
EOF
...
grep -q "196 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
