...
[[ "$keys_count" == "155" ]] || { echo "[m00] FAIL: expected 155 definitions, got $keys_count"; exit 1; }
...
assert impl == 153, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 153 implemented")
EOF
...
grep -q "207 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
