...
[[ "$keys_count" == "94" ]] || { echo "[m00] FAIL: expected 94 definitions, got $keys_count"; exit 1; }
...
assert impl == 92, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 92 implemented")
EOF
...
grep -q "268 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
