...
[[ "$keys_count" == "224" ]] || { echo "[m00] FAIL: expected 224 definitions, got $keys_count"; exit 1; }
...
assert impl == 222, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 222 implemented")
EOF
