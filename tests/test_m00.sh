...
[[ "$keys_count" == "107" ]] || { echo "[m00] FAIL: expected 107 definitions, got $keys_count"; exit 1; }
...
assert impl == 105, ("implemented definitions", impl)
print("[m00] registry mirror OK: published are present, planned are absent; 105 implemented")
EOF
...
grep -q "255 of the 360" "$ROOT/STATUS.md" || { echo "[m00] FAIL: STATUS.md must scope the 360-metric catalog"; exit 1; }
